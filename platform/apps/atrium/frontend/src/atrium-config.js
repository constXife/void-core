...
export const MESSAGES = {
  en: {
    ...
    "assistant.tabs.surfaces": "Surfaces",
    ...
    "assistant.message.reject": "Do not run",
    ...
    "composer.previewBridgeTitle": "Resolved bridge blocks",
    "composer.previewBridgeNote": "Phase 1 preview only renders assistant.latest_artifact bridge blocks. Inventory blocks land in P1.4.",
    "composer.previewBridgeEmpty": "No bridge blocks in this PageSpec.",
    ...
    "composer.title": "Custom surface composer",
    "composer.subtitle": "Describe the page you want; we'll assemble a valid layout from registered blocks.",
    "composer.pageKindLabel": "Page kind:",
    "composer.promptPanelTitle": "Prompt",
    "composer.promptLabel": "What should this page show?",
    "composer.promptPlaceholder": "e.g. an overview with KPI cards on top, low-stock items on the left, and locations on the right",
    "composer.compileButton": "Compile to PageSpec",
    "composer.compileLoading": "Compiling…",
    "composer.compileDisabledNote": "Describe the page above, then compile it into a PageSpec.",
    "composer.manifestPanelTitle": "Scoped manifest",
    "composer.manifestLoading": "Loading manifest…",
    "composer.manifestSummary": "Manifest: {pageKinds} page kind(s), {blocks} block(s), {dataSlots} data slot(s) — open to view JSON",
    "composer.pageSpecPanelTitle": "PageSpec",
    "composer.pageSpecEmpty": "PageSpec will appear here after a successful compile.",
    "composer.previewPanelTitle": "Preview",
    "composer.previewStubNote": "Validates the PageSpec against the live catalog and resolves any embedded skill artifacts.",
    "composer.previewButton": "Preview validation",
    "composer.previewLoading": "Validating…",
    "composer.savePanelTitle": "Save",
    "composer.saveStubNote": "Saves the PageSpec as a new version. Reload restores the latest saved layout.",
  ...
  ru: {
    ...
    "composer.previewBridgeTitle": "Resolved bridge blocks",
    "composer.previewBridgeNote": "Phase 1 preview рендерит только assistant.latest_artifact bridge blocks. Inventory blocks — P1.4.",
    "composer.previewBridgeEmpty": "В этом PageSpec нет bridge blocks.",
    ...
    "composer.title": "Композер кастомных поверхностей",
    "composer.subtitle": "Опишите страницу — соберём валидный layout из зарегистрированных блоков.",
    "composer.pageKindLabel": "Тип страницы:",
    "composer.promptPanelTitle": "Запрос",
    "composer.promptLabel": "Что должна показывать страница?",
    "composer.promptPlaceholder": "напр. сводка с KPI сверху, нехватки слева, локации справа",
    "composer.compileButton": "Скомпилировать PageSpec",
    "composer.compileLoading": "Компилируется…",
    "composer.compileDisabledNote": "Опиши страницу выше и скомпилируй её в PageSpec.",
    "composer.manifestPanelTitle": "Scoped-манифест",
    "composer.manifestLoading": "Загрузка манифеста…",
    "composer.manifestSummary": "Манифест: {pageKinds} тип(ов) страниц, {blocks} блок(ов), {dataSlots} data slot(ов) — раскрыть для JSON",
    "composer.pageSpecPanelTitle": "PageSpec",
    "composer.pageSpecEmpty": "PageSpec появится здесь после успешной компиляции.",
    "composer.previewPanelTitle": "Превью",
    "composer.previewStubNote": "Валидирует PageSpec против актуального каталога и резолвит встроенные skill-артефакты.",
    "composer.previewButton": "Запустить валидацию",
    "composer.previewLoading": "Валидация…",
    "composer.savePanelTitle": "Сохранить",
    "composer.saveStubNote": "Сохраняет PageSpec как новую версию. Перезагрузка восстанавливает последний сохранённый layout.",
