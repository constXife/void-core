...
export const MESSAGES = {
  en: {
    ...
    "surface.shopping.emptyRunBody": "Nothing is in the current shopping batch yet.",
    ...
    "surface.shopping.emptyClosedBody": "No recently closed shopping items yet.",
    ...
    "surface.action.closeShoppingRun": "Close run",
  ...
  ru: {
    ...
    "surface.shopping.emptyRunBody": "В текущем shopping batch пока ничего нет.",
    ...
    "surface.shopping.emptyClosedBody": "Недавно закрытых shopping-позиций пока нет.",
    ...
    "surface.action.closeShoppingRun": "Закрыть run",
