...
This documentation set defines the public foundation baseline of `void-core`.
...
Canonical documentation is English-first.

Translations may be added later, but they should be treated as secondary copies unless explicitly declared otherwise.
